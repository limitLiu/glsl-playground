...
pub fn ascii_art() {
    ...
    let (our_shader, vbo, vao, ebo, texture) = unsafe {
        let our_shader = Shader::new(
            "src/filters/shaders/ascii/ascii_art.vert",
            "src/filters/shaders/ascii/ascii_art.frag",
        );
